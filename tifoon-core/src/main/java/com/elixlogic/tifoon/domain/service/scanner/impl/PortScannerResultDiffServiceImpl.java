...
import com.elixlogic.tifoon.domain.model.object.ObjectTreeAware;
import com.elixlogic.tifoon.domain.model.scanner.diff.GlobalId;
...
public class PortScannerResultDiffServiceImpl implements PortScannerResultDiffService {
    ...
    private void addChange(@NonNull final ChangesHolder _changesHolder,
        ...
        log.debug("Adding change: {}", _propertyChange.toString());
